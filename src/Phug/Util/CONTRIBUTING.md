...
[Create new issue](https://github.com/phug-php/util/issues/new)
...
Fork the [GitHub project](https://github.com/phug-php/util) and chek out your copy locally:

```shell
git clone https://github.com/<username>/phug.git
cd phug
git remote add upstream https://github.com/phug-php/util.git
```
