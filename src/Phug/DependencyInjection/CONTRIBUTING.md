...
[Create new issue](https://github.com/phug-php/dependency-injection/issues/new)
...
Fork the [GitHub project](https://github.com/phug-php/dependency-injection) and chek out your copy locally:

```shell
git clone https://github.com/<username>/phug.git
cd phug
git remote add upstream https://github.com/phug-php/dependency-injection.git
```
