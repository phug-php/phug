...
[Create new issue](https://github.com/phug-php/formatter/issues/new)
...
Fork the [GitHub project](https://github.com/phug-php/formatter) and chek out your copy locally:

```shell
git clone https://github.com/<username>/phug.git
cd phug
git remote add upstream https://github.com/phug-php/formatter.git
```
